package com.kimjio.coral.util.glide;
...
public class RoundedCornersWithBorderTransformation extends BitmapTransformation {
    ...
    public RoundedCornersWithBorderTransformation(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public RoundedCornersWithBorderTransformation(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    public RoundedCornersWithBorderTransformation(int radius, int margin, @ColorInt int color, int border) {
        this(radius, margin, CornerType.BORDER);
        this.color = color;
        this.border = border;
    }
    ...
    private void drawBorder(Canvas canvas, Paint paint, float right, float bottom) {
        ...
        canvas.drawRoundRect(new RectF(margin, margin, right, bottom), radius, radius, paint);
        canvas.drawRoundRect(new RectF(margin, margin, right, bottom), radius, radius, strokePaint);
    }
    ...
    public boolean equals(Object o) {
        return o instanceof RoundedCornersWithBorderTransformation &&
                ...
                ((RoundedCornersWithBorderTransformation) o).diameter == diameter &&
                ((RoundedCornersWithBorderTransformation) o).margin == margin &&
                ((RoundedCornersWithBorderTransformation) o).cornerType == cornerType &&
                ((RoundedCornersWithBorderTransformation) o).border == border &&
                ((RoundedCornersWithBorderTransformation) o).color == color;
    }

    @Override
    public int hashCode() {
        return ID.hashCode() + radius * 1000000 + diameter * 100000 + margin * 10000 + cornerType.ordinal() * 1000 + border  * 100 + color * 10;
    }
