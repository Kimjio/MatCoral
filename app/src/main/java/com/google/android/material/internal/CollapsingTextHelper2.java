...
public final class CollapsingTextHelper2 {
    ...
    private void calculateOffsets(final float fraction) {
        ...
        if (collapsedTextColor != expandedTextColor) {
            ...
            textPaint.setColor(
                    blendColors(getCurrentExpandedTextColor(fraction), getCurrentCollapsedTextColor(), fraction));
        }
    ...
    @ColorInt
    private int getCurrentExpandedTextColor(float alpha) {
        int color = getCurrentColor(expandedTextColor);
        return Color.argb((int) (alpha * 255.0f + 0.5f), Color.red(color), Color.green(color), Color.blue(color));
    }
