 ...
 * CollapsingToolbarLayout2.LayoutParams#COLLAPSE_MODE_PARALLAX} and {@link CollapsingToolbarLayout2.LayoutParams#setParallaxMultiplier(float)}.
 *
 ...
 * {@link CollapsingToolbarLayout2.LayoutParams#COLLAPSE_MODE_PIN}.
 *
...
public class CollapsingToolbarLayout2 extends FrameLayout {
    ...
    public CollapsingToolbarLayout2(@NonNull Context context) {
        this(context, null);
    }

    public CollapsingToolbarLayout2(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CollapsingToolbarLayout2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (parent instanceof AppBarLayout) {
            ...
            if (onOffsetChangedListener == null) {
                onOffsetChangedListener = new CollapsingToolbarLayout2.OffsetUpdateListener();
            }
    ...
    private void updateDummyView() {
        ...
        if (collapsingTitleEnabled && toolbar != null) {
            ...
            if (dummyView.getParent() == null) {
                toolbar.addView(dummyView, CollapsingToolbarLayout2.LayoutParams.MATCH_PARENT, CollapsingToolbarLayout2.LayoutParams.MATCH_PARENT);
            }
        }
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof CollapsingToolbarLayout2.LayoutParams;
    }

    @Override
    protected CollapsingToolbarLayout2.LayoutParams generateDefaultLayoutParams() {
        return new CollapsingToolbarLayout2.LayoutParams(CollapsingToolbarLayout2.LayoutParams.MATCH_PARENT, CollapsingToolbarLayout2.LayoutParams.MATCH_PARENT);
    }

    @Override
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new CollapsingToolbarLayout2.LayoutParams(getContext(), attrs);
    }

    @Override
    protected FrameLayout.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new CollapsingToolbarLayout2.LayoutParams(p);
    }
    ...
    final int getMaxOffsetForPinChild(@NonNull View child) {
        ...
        final CollapsingToolbarLayout2.LayoutParams lp = (CollapsingToolbarLayout2.LayoutParams) child.getLayoutParams();
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            for (int i = 0, z = getChildCount(); i < z; i++) {
                ...
                switch (lp.collapseMode) {
                    case CollapsingToolbarLayout2.LayoutParams.COLLAPSE_MODE_PIN:
                        offsetHelper.setTopAndBottomOffset(
                                MathUtils.clamp(-verticalOffset, 0, getMaxOffsetForPinChild(child)));
                        break;
                    case CollapsingToolbarLayout2.LayoutParams.COLLAPSE_MODE_PARALLAX:
